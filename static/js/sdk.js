...
(function(window){
    ...
    var SEC = function() {
        ...
        this.create = function(index, element) {
            ...
            if (element.getAttribute('data-nonce') != null) {
            	iframe.src = iframe.src + '&se_nonce=' + element.getAttribute('data-nonce');
            }
    ...
    SECWidget.prototype.config = function (options) {
        ...
        this.ready(function() {
            if (typeof options.code !== 'undefined') {
                _widget.loadCode(options.code.compiler, options.code.source, options.code.input);
            }
            ...
            if (typeof options.compilers !== 'undefined') {
                _widget.chooseCompilers(options.compilers.list, options.compilers.selected);
            }
            
            SECUtils.log('info', 'widget', 'config');
        });
    };
    ...
    SECWidget.prototype.loadCode = function (codeCompiler, codeSource, codeInput) {
        ...
        var _widget = this;
        this.ready(function() {
            _widget.iframe.contentWindow.postMessage({event: 'loadCode', data: {
            ...
            SECUtils.log('info', 'widget', 'load code');
        });
    };
    ...
    SECWidget.prototype.chooseCompilers = function (compilersList) {
        ...
        var _widget = this;
        this.ready(function() {
            _widget.iframe.contentWindow.postMessage({event: 'chooseCompilers', data: {
                list: typeof compilersList !== 'undefined' ? compilersList : null
            }}, '*');
        
            SECUtils.log('info', 'widget', 'choose compilers');
        });
    };
	...
	SECWidgetEvents.prototype.subscribe = function (eventName, eventCallback) {
        ...
        SECUtils.log('info', 'widget.events', 'subscribe');
	};
	...
	SECWidgetEvents.prototype.unsubscribe = function (eventName, eventCallback) {
        ...
        SECUtils.log('info', 'widget.events', 'unsubscribe');
	};
    ...
    SECWidgetToolbar.prototype.createButton = function (groupId, buttonId, buttonIcon, buttonType, buttonTooltip, buttonCallback) {
        ...
        this.widget.ready(function() {
            ...
            SECUtils.log('info', 'widget.toolbar', 'create button');
        });
    };
    ...
    SECWidgetToolbar.prototype.deleteButton = function (buttonId) {
        ...
        this.widget.ready(function() {
            ...
            SECUtils.log('info', 'widget.toolbar', 'delete button');
        });
    };
    ...
    SECWidgetToolbar.prototype.createButtonGroup = function (groupId, groupButtons) {
        ...
        this.widget.ready(function() {
            ...
            SECUtils.log('info', 'widget.toolbar', 'create button group');
        });
    };
    ...
    SECWidgetToolbar.prototype.deleteButtonGroup = function (groupId) {
        ...
        this.widget.ready(function() {
            ...
            SECUtils.log('info', 'widget.toolbar', 'delete button group');
        }); 
    };
     ...
     */
    SECUtils.log = function(type, module, message) {
